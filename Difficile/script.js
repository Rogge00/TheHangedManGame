...
function init_word () {
  ...
  for (i = 0; i < word.length; i++) {
    ...
    var reveal = (i == 0 || i == word.length -1) ? chr : (vowels.indexOf (chr) == -1) ? "&nbsp&nbsp" : "&nbsp&nbsp";
...
function check_endgame () {
  if (image > 6) {
	...
	top.location.href = "../FinalScreen/LoseD.html";
    // SOMETHING ON-LOOSE
  } 
  
  if (rightChars == word.length) {
    alert ("Yeah, hai vinto!");
	top.location.href = "../FinalScreen/WinD.html";
    // SOMETHING ON-WIN
  }
}
